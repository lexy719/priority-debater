import { marketGrowth, marketSignals } from "@/data/mockData";
import {
            ...
            <div className="relative mx-auto max-w-[1480px] px-6 lg:px-10">
                <div className="mb-12 grid gap-8 lg:grid-cols-12">
                    <div className="lg:col-span-7">
                        <div className="font-mono text-[10px] tracking-wider text-neutral-500">§03 / MARKET POTENTIAL</div>
                    ...
                    <div className="lg:col-span-5 lg:pt-6">
                        <p className="font-mono text-sm leading-relaxed text-neutral-600">
                            Real-time market sizing grounded in 2026 data. TAM expands from
                            $2.1B today to $4.7B by 2030 — driven by EU ICE bans and a
                            34% YoY rise in last-mile fuel cost.
                        </p>
                    </div>
                </div>
                ...
                <div className="relative border-2 border-black bg-white p-6 shadow-brutal lg:p-10">
                    <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
                        <div>
                            ...
                            <div className="mt-1 font-display text-2xl">TAM / SAM / SOM — 2024 → 2030</div>
                        </div>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={marketGrowth} margin={{ top: 12, right: 12, bottom: 0, left: 0 }}>
                                ...
                                <YAxis
                                    ...
                                    axisLine={false}
                                    tickLine={false}
                                    label={{ value: "TAM ($B)", angle: -90, position: "insideLeft", fontFamily: "JetBrains Mono", fontSize: 10, fill: "#666" }}
                                />
                                <YAxis
                                    yAxisId="right"
                                    orientation="right"
                                    ...
                                    axisLine={false}
                                    tickLine={false}
                                    label={{ value: "SAM/SOM ($M)", angle: 90, position: "insideRight", fontFamily: "JetBrains Mono", fontSize: 10, fill: "#666" }}
                                />
                                <Tooltip
                                    contentStyle={{
                                        background: "#0a0a0a",
