import { idea, overallScore } from "@/data/mockData";
                ...
                <div className="grid gap-12 lg:grid-cols-12">
                    ...
                    <div className="lg:col-span-7">
                        ...
                        <p className="mt-8 max-w-xl font-mono text-sm leading-relaxed text-white/60">
                            ...
                            sugar-coating. The panel has reached a verdict — below is the
                            cold-metric breakdown.
                        </p>
                        ...
                        <div className="mt-10 grid grid-cols-3 gap-px border border-white/20 bg-white/10">
                            <div className="bg-black p-5">
                                ...
                                <div className="mt-3 flex items-center gap-2">
                                    <CheckCircle2 className="h-5 w-5 text-[var(--c-green)]" />
                            ...
                            <div className="bg-black p-5">
                                ...
                                <div className="mt-2 h-1 w-full bg-white/15">
                                    <div className="h-full bg-white" style={{ width: `${idea.confidencePct}%` }} />
                                </div>
                            </div>
                            <div className="bg-black p-5">
                                ...
                                <div className="mt-1 font-mono text-[10px] text-white/40">of 26,606 validated</div>
                            </div>
                        </div>
                    </div>

                    {/* RIGHT — huge score card */}
                    <div className="lg:col-span-5">
                        <div data-testid="overall-score-card" className="relative border border-white/40 bg-black p-8">
                            ...
                            <div className="flex items-baseline gap-4">
                                <span data-testid="overall-score-value" className="font-display text-[180px] leading-none text-[var(--hi)] sm:text-[200px]">
                                    {overallScore.score}
                                </span>
                            ...
                            <div className="mt-2 flex items-center gap-2 font-mono text-xs text-[var(--c-green)]">
                                ...
                                +{overallScore.score - overallScore.benchmark} vs INDUSTRY AVG ({overallScore.benchmark})
                            </div>
                            ...
                            <div className="mt-4 grid grid-cols-5 gap-1 font-mono text-[10px] text-white/40">
                                {overallScore.history.map((h) => (
                                    <span key={h.v} className="text-center">{h.v}</span>
                                ))}
                            </div>
                        </div>
                    </div>
