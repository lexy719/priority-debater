import { coldMetrics } from "@/data/mockData";
            ...
            <div className="mx-auto max-w-[1480px] px-6 lg:px-10">
                <div className="mb-6 flex items-end justify-between">
                    <h2 className="font-display text-2xl lg:text-3xl">
                        A REAL REPORT, <span className="hl-strip-dark border border-white">IN COLD METRICS.</span>
                    </h2>
                    <div className="font-mono text-[10px] tracking-wider text-white/50">§02 / METRICS</div>
                </div>
