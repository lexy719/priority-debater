...
export function Monogram({ size = 96, color = "currentColor", accent }) {
    return (
        <svg
            width={size}
            height={size}
...
export function Wordmark({ color = "currentColor", accent = "#7dd3fc" }) {
    return (
...
export function Lockup({ color = "currentColor", accent = "#7dd3fc", monoSize = 36 }) {
    return (
